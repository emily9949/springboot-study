...
public class ResolverController {
    ...
    *  */
    ...
    public String stringReturning(Model model) {
        model.addAttribute("fowardMessage", "문자열로 뷰 이름 반환함...");
    ...
    public String stringRedirect(Model model) {
        ...
        return "redirect:/"; // 다시 main.html으로 Redirect 요청
    }
    ...
    /* 설명. foward를 통한 화면의 재료는 Model, redirect를 통한 화면의 재료는 RedirectAttributes */
